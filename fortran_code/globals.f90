...
! multiple types
 ...
 ! pfi 
    ...
    integer, parameter :: n_a = 50, n_aime = 11, n_sp_risk = 7, n_sd =1, n_sr = 1, n_beq = 1, n_sp_fix = 1, n_superstar = 2 ! convention here is that there are (n_sp_risk - n_superstar) ordinary income grid points
