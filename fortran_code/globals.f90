...
IMPLICIT NONE
   save
    ...
    integer :: switch_drop_psid_superstars                  ! 0 - use mostdrop files, 1 - use busno_drop files (for nstr scenario)
...
! multiple types
 ...
 ! pfi
    ...
    integer, parameter :: n_a = 50, n_aime = 7, n_sp_risk = 6, n_sd =4, n_sr = 3, n_beq =3, n_sp_fix = 1, n_superstar = 1 ! convention here is that there are (n_sp_risk - n_superstar) ordinary income grid points
