...
! multiple types
 ...
 ! pfi
    ...
    integer, parameter :: n_a = 50, n_aime = 7, n_sp_risk = 5, n_sd =4, n_sr = 3, n_beq =2, n_sp_fix = 1, n_superstar = 0 ! convention here is that there are (n_sp_risk - n_superstar) ordinary income grid points
