...
!
! DESCRIPTION:
!   Steady-state life-cycle profile computation. Given prices (r_bar_ss,
!   w_bar_ss) and pension parameters, solves the household problem via PFI,
!   computes distributions, and aggregates to get age profiles of consumption,
!   labor, savings, and pension benefits.
!
! MODULE: prof_steady
!   Subroutine: profile_steady — inner loop of the steady-state solver
!===============================================================================
