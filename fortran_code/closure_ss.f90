...
!
! DESCRIPTION:
!   Government budget closure for steady state. Computes g_ss (government
!   spending) as residual that balances the budget constraint. Handles
!   net vs gross capital tax base (switch_tauK_gross).
!
! INCLUDED IN: steady_state.f90 via include statement
!   Transition counterpart: closures.f90
!
! KEY OUTPUTS: g_ss, g_per_capita_ss, g_share_ss, deficit_ss
!===============================================================================
