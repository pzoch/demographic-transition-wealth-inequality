...
!
! DESCRIPTION:
!   Bequest distribution for transition path. Computes accidental bequests
!   left by deceased agents and distributes them to survivors.
!
! INCLUDED IN: transition.f90 via include statement
!
! BEQUEST MODES (switch_unequal_bequest):
!   0 = Equal distribution within age group (default, all main scenarios)
!   1 = Per capita to newborns
!   2 = Unequal distribution via Zipf law (beqs_* scenarios)
!
! KEY OUTPUTS: bequest_left_j, bequest, bequest_j, beq_zipf_trans_big
!===============================================================================
