...
double precision function uncertainty(sav, lti_past, lti_fut, jj)
    double precision :: sav, lhs, rhs(2)
    double precision :: lti_past, lti_fut(2)
    integer :: jj, mm
    ...
    uncertainty = (lhs - ((1.0_dp-prob)*rhs(1)+prob*rhs(2)) )**2
end function uncertainty

double precision function fmin(ax, bx, f, tol, lti_past, lti_fut, jj)
