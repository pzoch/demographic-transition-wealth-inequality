                                    ...
                                    INTERFACE get_diag
                                      ...
                                      CONTAINS
                                        ...
                                        SUBROUTINE array_copy_d(src,dest,n_copied,n_not_copied)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: src
                                          real(DPP), DIMENSION(:), INTENT(OUT) :: dest
                                        ...
                                        SUBROUTINE swap_rv(a,b)
                                          REAL(DPP), DIMENSION(:), INTENT(INOUT) :: a,b
                                          REAL(DPP), DIMENSION(SIZE(a)) :: dum
                                          dum=a
                                          a=b
                                          b=dum
                                        ...
                                        SUBROUTINE masked_swap_rm(a,b,mask)
                                          real(DPP), DIMENSION(:,:), INTENT(INOUT) :: a,b
                                          LOGICAL(LGT), DIMENSION(:,:), INTENT(IN) :: mask
                                          real(DPP), DIMENSION(size(a,1),size(a,2)) :: swp
                                          where (mask)
                                            swp=a
                                            a=b
                                            b=swp
                                        ...
                                        FUNCTION reallocate_rv(p,n)
                                          real(DPP), DIMENSION(:), POINTER :: p, reallocate_rv
                                        ...
                                        FUNCTION reallocate_rm(p,n,m)
                                          real(DPP), DIMENSION(:,:), POINTER :: p, reallocate_rm
                                        ...
                                        FUNCTION arth_r(first,increment,n)
                                          real(DPP), INTENT(IN) :: first,increment
                                          INTEGER(I4B), INTENT(IN) :: n
                                          real(DPP), DIMENSION(n) :: arth_r
                                          INTEGER(I4B) :: k,k2
                                          real(DPP) :: temp
                                        ...
                                        FUNCTION geop_r(first,factor,n)
                                          real(DPP), INTENT(IN) :: first,factor
                                          INTEGER(I4B), INTENT(IN) :: n
                                          real(DPP), DIMENSION(n) :: geop_r
                                          INTEGER(I4B) :: k,k2
                                          real(DPP) :: temp
                                        ...
                                        FUNCTION geop_dv(first,factor,n)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: first,factor
                                          INTEGER(I4B), INTENT(IN) :: n
                                          real(DPP), DIMENSION(size(first),n) :: geop_dv
                                          INTEGER(I4B) :: k,k2
                                          real(DPP), DIMENSION(size(first)) :: temp
                                        ...
                                        RECURSIVE FUNCTION cumsum_r(arr,seed) RESULT(ans)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: arr
                                          real(DPP), OPTIONAL, INTENT(IN) :: seed
                                          real(DPP), DIMENSION(size(arr)) :: ans
                                          INTEGER(I4B) :: n,j
                                          real(DPP) :: sd
                                          n=size(arr)
                                          if (n == 0_i4b) RETURN
                                        ...
                                        FUNCTION poly_rr(x,coeffs)
                                          ...
                                          real(DPP), DIMENSION(:), INTENT(IN) :: coeffs
                                          real(DPP) :: poly_rr
                                          real(DPP) :: pow
                                          real(DPP), DIMENSION(:), ALLOCATABLE :: vec
                                          INTEGER(I4B) :: i,n,nn
                                          n=size(coeffs)
                                          if (n <= 0) then
                                            poly_rr=0.0
                                        ...
                                        FUNCTION poly_rrv(x,coeffs)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: coeffs,x
                                          real(DPP), DIMENSION(size(x)) :: poly_rrv
                                          INTEGER(I4B) :: i,n,m
                                          m=size(coeffs)
                                          n=size(x)
                                          if (m <= 0) then
                                        ...
                                        FUNCTION poly_ddv(x,coeffs)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: coeffs,x
                                          real(DPP), DIMENSION(size(x)) :: poly_ddv
                                          INTEGER(I4B) :: i,n,m
                                          m=size(coeffs)
                                          n=size(x)
                                          if (m <= 0) then
                                        ...
                                        FUNCTION poly_msk_rrv(x,coeffs,mask)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: coeffs,x
                                          LOGICAL(LGT), DIMENSION(:), INTENT(IN) :: mask
                                          real(DPP), DIMENSION(size(x)) :: poly_msk_rrv
                                          poly_msk_rrv=unpack(poly_rrv(pack(x,mask),coeffs),mask,0.0_dpp)
                                        END FUNCTION poly_msk_rrv
                                        !BL
                                        FUNCTION poly_msk_ddv(x,coeffs,mask)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: coeffs,x
                                          LOGICAL(LGT), DIMENSION(:), INTENT(IN) :: mask
                                          real(DPP), DIMENSION(size(x)) :: poly_msk_ddv
                                          poly_msk_ddv=unpack(poly_ddv(pack(x,mask),coeffs),mask,0.0_dpp)
                                        END FUNCTION poly_msk_ddv
                                        !BL
                                        !BL
                                        RECURSIVE FUNCTION poly_term_rr(a,b) RESULT(u)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a
                                          real(DPP), INTENT(IN) :: b
                                          real(DPP), DIMENSION(size(a)) :: u
                                          INTEGER(I4B) :: n,j
                                          n=size(a)
                                          if (n <= 0) RETURN
                                          u(1)=a(1)
                                        ...
                                        FUNCTION outerprod_r(a,b)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a,b
                                          real(DPP), DIMENSION(size(a),size(b)) :: outerprod_r
                                        ...
                                        FUNCTION outerprod_d(a,b)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a,b
                                          real(DPP), DIMENSION(size(a),size(b)) :: outerprod_d
                                        ...
                                        FUNCTION outerdiv(a,b)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a,b
                                          real(DPP), DIMENSION(size(a),size(b)) :: outerdiv
                                        ...
                                        FUNCTION outersum(a,b)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a,b
                                          real(DPP), DIMENSION(size(a),size(b)) :: outersum
                                        ...
                                        FUNCTION outerdiff_r(a,b)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a,b
                                          real(DPP), DIMENSION(size(a),size(b)) :: outerdiff_r
                                        ...
                                        FUNCTION outerdiff_d(a,b)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: a,b
                                          real(DPP), DIMENSION(size(a),size(b)) :: outerdiff_d
                                        ...
                                        SUBROUTINE scatter_add_r(dest,source,dest_index)
                                          real(DPP), DIMENSION(:), INTENT(OUT) :: dest
                                          real(DPP), DIMENSION(:), INTENT(IN) :: source
                                        ...
                                        SUBROUTINE diagadd_rv(mat,diag)
                                          real(DPP), DIMENSION(:,:), INTENT(INOUT) :: mat
                                          real(DPP), DIMENSION(:), INTENT(IN) :: diag
                                          INTEGER(I4B) :: j,n
                                        ...
                                        FUNCTION get_diag_rv(mat)
                                          real(DPP), DIMENSION(:,:), INTENT(IN) :: mat
                                          real(DPP), DIMENSION(size(mat,1)) :: get_diag_rv
                                          INTEGER(I4B) :: j
                                        ...
                                        FUNCTION get_diag_dv(mat)
                                          real(DPP), DIMENSION(:,:), INTENT(IN) :: mat
                                          real(DPP), DIMENSION(size(mat,1)) :: get_diag_dv
                                          INTEGER(I4B) :: j
                                        ...
                                        SUBROUTINE put_diag_rv(diagv,mat)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: diagv
                                          real(DPP), DIMENSION(:,:), INTENT(INOUT) :: mat
                                          INTEGER(I4B) :: j,n
                                        ...
                                        SUBROUTINE unit_matrix(mat)
                                          real(DPP), DIMENSION(:,:), INTENT(OUT) :: mat
                                          INTEGER(I4B) :: i,n
                                          n=min(size(mat,1),size(mat,2))
                                          mat(:,:)=0.0
                                          do i=1,n
                                        ...
                                        !BL
                                        FUNCTION vabs(v)
                                          real(DPP), DIMENSION(:), INTENT(IN) :: v
                                          real(DPP) :: vabs
