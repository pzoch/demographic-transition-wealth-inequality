...
! enddo 
    ...
    if (switch_run_2 == 1) then
        ...
        call steady(switch_residual_2, switch_tauK_gross, switch_unequal_bequest, switch_param_2, switch_type_2, k_ss_2, r_ss_2, r_bar_ss_2, w_bar_ss_2, l_ss_j_2,  w_ss_j_2, s_ss_j_2, c_ss_j_2, b_ss_j_2 ,upsilon_r_ss_2, t1_ss_2, g_per_capita_ss_2, b1_ss_j_2, b2_ss_j_2, pillar1_ss_j_2, pillar2_ss_j_2, bequest_ss_j_2, bequest_ss_2, lab_ss_j_2)       
    endif ! run_2
