...
! theta = 1.0d0 + real(iter_theta)/100d0
    if (switch_run_1 == 1) then
        call steady(switch_residual_1, switch_tauK_gross, switch_unequal_bequest, switch_param_1, switch_type_1, rho_1,k_ss_1, r_ss_1, r_bar_ss_1, w_bar_ss_1, w_bar_ss_L_1, w_bar_ss_H_1,  l_ss_j_1, w_ss_j_1, s_ss_j_1, c_ss_j_1, b_ss_j_1, l_ss_j_H_1, w_ss_j_H_1, s_ss_j_H_1, c_ss_j_H_1, b_ss_j_H_1, l_ss_j_L_1, w_ss_j_L_1, s_ss_j_L_1, c_ss_j_L_1, b_ss_j_L_1,upsilon_r_ss_1, t1_ss_1, g_per_capita_ss_1, b1_ss_j_1, b2_ss_j_1, b1_ss_j_1_L, b2_ss_j_1_L, b1_ss_j_1_H, b2_ss_j_1_H, pillar1_ss_j_1, pillar2_ss_j_1)       
    endif ! run_1
    write(*,*) V_ss_j_vfi(1)
! enddo 
